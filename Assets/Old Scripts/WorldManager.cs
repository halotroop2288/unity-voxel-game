...
using UnifiedFactorization.GUI;
...
namespace Minecraft {
	public sealed class WorldManager : MonoBehaviour {
		...
		[SerializeField] private PauseMenu m_PauseManu;
		...
		public Item GetCurrentItem() {
			return m_PlayerInventory.MainSlots[0].Stack.GetItem;
		}

		public void SetItem(int index, Item type, int amount) {
			m_PlayerInventory.SetItem(index, type, amount);
		}
