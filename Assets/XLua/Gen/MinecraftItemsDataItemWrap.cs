...
namespace XLua.CSObjectWrap {
	...
	public class MinecraftItemsDataItemWrap {
		...
		private static int __CreateInstance(RealStatePtr L) {
			try {
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		...
		[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
		private static int _g_get_ItemName(RealStatePtr L) {
			try {
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		...
		[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
		private static int _g_get_Type(RealStatePtr L) {
			try {
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		...
		[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
		private static int _g_get_MappedBlockType(RealStatePtr L) {
			try {
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);

				Minecraft.ItemsData.BlockItem gen_to_be_invoked = (Minecraft.ItemsData.BlockItem)translator.FastGetCSObj(L, 1);
		...
		[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
		private static int _g_get_MaxStackSize(RealStatePtr L) {
			try {
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		...
		[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
		private static int _g_get_DiggingSpeed(RealStatePtr L) {
			try {
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		...
		[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
		private static int _g_get_Icon(RealStatePtr L) {
			try {
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
